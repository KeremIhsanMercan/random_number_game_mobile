...
export default function EasyModeScreen() {
  ...
  const [boxes, setBoxes] = useState<(number | null)[]>(Array(5).fill(null));
  const [showInvalidPlacement, setShowInvalidPlacement] = useState(6); // No box is invalid at start
