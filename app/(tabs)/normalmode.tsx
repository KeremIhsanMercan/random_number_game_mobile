...
export default function NormalModeScreen() {
  ...
  const [boxes, setBoxes] = useState<(number | null)[]>(Array(10).fill(null));
  const [showInvalidPlacement, setShowInvalidPlacement] = useState(11); // No box is invalid at start
